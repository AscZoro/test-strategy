...
- **Test Step:** 1
- **Test Step Description:** Navigate directly into the 'My Appointments' page grid dashboard view.
...
- **Test Step:** 1
- **Test Step Description:** Inspect keyboard tab focus sequence traversals across the list elements components.
...
- **Test Step:** 1
- **Test Step Description:** Trigger page view lookup refresh command parameters.
...
## TC010 Local Time Zone Conversion
